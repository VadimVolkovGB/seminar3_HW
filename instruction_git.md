...
### Отправка изменений владельцу репозитория (Pull Request)

После того, как вы "запушили" изменения на удаленный fork-репозиторий, вверху вам будет доступна кнопка Pull Request в верхней части над списком файлов вашего репозитория.

Воспользуйтесь ей, и ваши изменения отправятся владельцу fork-репозитория. Владелец сможет просмотреть ваши изменения, принять или отклонить их.